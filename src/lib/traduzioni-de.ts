...
export const TESTI_DE: Record<string, string> = {
  ...
  'comune.rispostaIncompleta': "Unvollständige Antwort des Servers",
  'comune.utenteNonIndicato': "Kein Benutzer angegeben",
  'comune.passwordNonRestituita': "Der Server hat kein Passwort zurückgegeben",
  ...
  'Updates the tasks contained in the file. Nothing is deleted.':
    'Aktualisiert die im Datei enthaltenen Aufgaben. Es wird nichts geloescht.',
  ...
  'Generated on {date}': 'Erstellt am {date}',
  "Reset {name}'s password": 'Passwort von {name} zurücksetzen',
  'Edit {name}': '{name} bearbeiten',
  'Remove from team': 'Aus dem Team entfernen',
  'Remove {name}': '{name} entfernen',
  'No team members yet': 'Noch keine Teammitglieder',
  ...
  'Delivery provider and test send': 'Zustellanbieter und Testversand',
  'The API key and the sender address are configured on the server only, in the project environment variables ({keyVariables}, {fromVariable}).': 'API-Schlüssel und Absenderadresse werden ausschließlich auf dem Server konfiguriert, in den Umgebungsvariablen des Projekts ({keyVariables}, {fromVariable}).',
  'Do not enter them here: they would be stored in clear text in the organisation database and loaded into the browser of anyone who opens the application.': 'Trage sie hier nicht ein: Sie landen sonst im Klartext in der Datenbank der Organisation und im Browser aller, die die Anwendung öffnen.',
  'Preferred provider': 'Bevorzugter Anbieter',
  'Used when the matching key is configured on the server; otherwise the available one is chosen automatically.': 'Wird verwendet, wenn der passende Schlüssel auf dem Server hinterlegt ist; sonst wird automatisch der verfügbare Anbieter gewählt.',
  'Provider': 'Anbieter',
  'The recipient must be a member of this organisation: the endpoint rejects external addresses, so that it cannot become a relay for the verified domain.': 'Die empfangende Person muss Mitglied dieser Organisation sein: Der Endpunkt lehnt externe Adressen ab, damit er kein Relay im Namen der verifizierten Domain wird.',
  'colleague@company.com': 'kollege@firma.de',
  'Sending…': 'Wird gesendet…',
  'Send test': 'Test senden',
  'You need the manager role or higher.': 'Erforderlich ist die Rolle Manager oder höher.',
  'Actual delivery outcomes are shown in "{section}".': 'Die tatsächlichen Zustellergebnisse stehen unter „{section}“.',
  'Test send': 'Testversand',
  'Enter an address to send the test to': 'Geben Sie eine Adresse für den Testversand an',
  'The file contains no data to restore': 'Die Datei enthält keine wiederherstellbaren Daten',
  'AI features are not active': 'Die KI-Funktionen sind nicht aktiv',
  'Could not create the user': 'Benutzer konnte nicht angelegt werden',
  'Could not remove': 'Entfernen fehlgeschlagen',
  'Could not reset the password': 'Passwort konnte nicht zurückgesetzt werden',
  'Could not generate insights': 'Die Auswertungen konnten nicht erstellt werden',
  'Could not update the role': 'Rolle konnte nicht aktualisiert werden',
  'Unknown error': 'Unbekannter Fehler',
  'invalid format': 'ungültiges Format',
  'Could not load your tasks': 'Die Aufgaben konnten nicht geladen werden',
  'Check your connection and try again. Nothing has been lost.': 'Prüfen Sie Ihre Verbindung und versuchen Sie es erneut. Es ist nichts verloren gegangen.',
  'Try again': 'Erneut versuchen',
  'Waiting for these tasks': 'Wartet auf diese Aufgaben',
  'Task no longer available': 'Aufgabe nicht mehr vorhanden',
  'This task now waits for {title}': 'Diese Aufgabe wartet jetzt auf {title}',
  'This task no longer waits for {title}': 'Diese Aufgabe wartet nicht mehr auf {title}',
  'Done — no longer holds this task': 'Erledigt – hält diese Aufgabe nicht mehr auf',
  'Still open': 'Noch offen',
  'Stop waiting for {title}': 'Nicht mehr auf {title} warten',
  'This task does not wait for anything': 'Diese Aufgabe wartet auf nichts',
  'Search a task that must be done first': 'Suche eine Aufgabe, die vorher fertig sein muss',
  'Tasks that can come first': 'Aufgaben, die vorher kommen können',
  'No other task to wait for': 'Keine weitere Aufgabe zum Abwarten',
  'Not available: that task is already waiting for this one': 'Nicht möglich: jene Aufgabe wartet bereits auf diese',
  'A task can be completed only after everything it waits for is done.': 'Eine Aufgabe kann erst abgeschlossen werden, wenn alles erledigt ist, worauf sie wartet.',
  'Waiting for one other task to be done': 'Wartet darauf, dass eine andere Aufgabe fertig wird',
  'Waiting for {count} other tasks to be done': 'Wartet darauf, dass {count} andere Aufgaben fertig werden',
  'Blocked by other tasks': 'Von anderen Aufgaben blockiert',
  'Open {title}': '{title} öffnen',
  'This task can be completed once those are done.': 'Diese Aufgabe kann abgeschlossen werden, sobald jene erledigt sind.',
  'Finish these first: {tasks}': 'Schließen Sie zuerst ab: {tasks}',
  'Steps': 'Schritte',
  '{done} of {total} done': '{done} von {total} erledigt',
  'No steps yet': 'Keine Schritte',
  'Add a step': 'Schritt hinzufügen',
  'Add step': 'Schritt hinzufügen',
  'Step text': 'Text des Schritts',
  'Step added: {name}': 'Schritt hinzugefügt: {name}',
  'Step deleted: {name}': 'Schritt gelöscht: {name}',
  'Step moved to position {position} of {total}': 'Schritt an Position {position} von {total} verschoben',
  'Move step up: {name}': 'Schritt nach oben verschieben: {name}',
  'Move step down: {name}': 'Schritt nach unten verschieben: {name}',
  'Rename step: {name}': 'Schritt umbenennen: {name}',
  'Delete step: {name}': 'Schritt löschen: {name}',
  'A task can have at most {max} steps. For more, create separate tasks.': 'Eine Aufgabe kann höchstens {max} Schritte haben. Für mehr erstelle separate Aufgaben.',
  'Only a manager can remove the approval requirement, and not on their own task.': 'Nur eine verantwortliche Person kann die Genehmigungspflicht entfernen, und nicht bei der eigenen Aufgabe.',
  'To enable notifications, please allow them in your browser settings:': 'Um Benachrichtigungen zu erhalten, erlauben Sie sie in den Browsereinstellungen:',
  'Settings → Privacy → Site Settings → Notifications': 'Einstellungen → Datenschutz → Website-Einstellungen → Benachrichtigungen',
  'Enabled': 'Aktiviert',
  'Not Set': 'Nicht festgelegt',
  'Improvement': 'Verbesserung',
  'Department details and team members': 'Abteilungsdetails und Teammitglieder',
  'Blue': 'Blau',
  'Green': 'Grün',
  'Purple': 'Lila',
  'Orange': 'Orange',
  ...
  'Indigo': 'Indigo',
  'Cyan': 'Cyan',
  'View details for department {name}': 'Details der Abteilung {name} anzeigen',
  'Edit department {name}': 'Abteilung {name} bearbeiten',
  'Archive department {name}': 'Abteilung {name} archivieren',
  'Delete department {name}': 'Abteilung {name} löschen',
  'Filter by category': 'Nach Kategorie filtern',
  'Filter by status': 'Nach Status filtern',
  'Filter by department': 'Nach Abteilung filtern',
  'Filter by role': 'Nach Rolle filtern',
  'Change status for {title}': 'Status von {title} ändern',
  'Upvote {title}': 'Für {title} stimmen',
  'List view': 'Listenansicht',
  'Grid view': 'Rasteransicht',
  'Search team members': 'Teammitglieder durchsuchen',
  'Import Backup': 'Backup importieren',
  'Error Details:': 'Fehlerdetails:',
  'Open Rate %': 'Öffnungsrate %',
  'Click Rate %': 'Klickrate %',
  'HTML content...': 'HTML-Inhalt ...',
  'Plain text content...': 'Nur-Text-Inhalt ...',
  'Real delivery outcomes recorded by the server. Opens and clicks are not tracked: those values stay at zero.': 'Tatsächliche Zustellergebnisse, die der Server aufgezeichnet hat. Öffnungen und Klicks werden nicht erfasst: Diese Werte bleiben bei null.',
  'Logs not readable: {reason}': 'Protokolle nicht lesbar: {reason}',
  'Time range': 'Zeitraum',
  'Email type': 'E-Mail-Typ',
  'No active organization': 'Keine aktive Organisation',
  'Backup exported: {chiavi} keys and {task} tasks': 'Backup exportiert: {chiavi} Schlüssel und {task} Aufgaben',
  'Export failed: {reason}': 'Export fehlgeschlagen: {reason}',
  'Restore failed: {reason}': 'Wiederherstellung fehlgeschlagen: {reason}',
  'and they stay hidden from users. Reason reported by the server:': 'und bleiben für die Benutzer ausgeblendet. Vom Server gemeldeter Grund:',
  'not specified': 'nicht angegeben',
  'If the key is not tied to a workspace, set the ANTHROPIC_WORKSPACE_ID environment variable or use a key already associated with a workspace.': 'Wenn der Schlüssel an keinen Workspace gebunden ist, setze die Umgebungsvariable ANTHROPIC_WORKSPACE_ID oder verwende einen Schlüssel, der bereits einem Workspace zugeordnet ist.',
  'Send': 'Senden',
  'e.g. 90, 1.5h, 2h 30m': 'z. B. 90, 1,5h, 2h 30m',
  'sorted descending, activate to sort ascending': 'absteigend sortiert, aktivieren, um aufsteigend zu sortieren',
  'sorted ascending, activate to sort descending': 'aufsteigend sortiert, aktivieren, um absteigend zu sortieren',
  'activate to sort by this column': 'aktivieren, um nach dieser Spalte zu sortieren',
  'Estimate': 'Schätzung',
  'Time Spent': 'Aufgewendete Zeit',
  'Created': 'Erstellt am',
  'Completed On': 'Abgeschlossen am',
  'Departments: {departments} · Assigned tasks: {tasks}': 'Abteilungen: {departments} · Zugewiesene Aufgaben: {tasks}',
  'A new version is available': 'Eine neue Version ist verfügbar',
  'Reload to get the latest version.': 'Laden Sie neu, um die neueste Version zu erhalten.',
  'Reload': 'Neu laden',
  'Completed tasks: {count}': 'Abgeschlossene Aufgaben: {count}',
  '{count} could not be closed: they are waiting for other tasks': '{count} konnten nicht geschlossen werden: sie warten auf andere Aufgaben',
  'Tasks moved to {status}: {count}': 'Aufgaben auf {status} gesetzt: {count}',
  'Administration': 'Verwaltung',
  'Help me move this task forward. If something is unclear, ask me instead of making it up.': 'Hilf mir, diese Aufgabe voranzubringen. Wenn etwas unklar ist, frag mich, statt es dir auszudenken.',
  ...
  'Connector (MCP)': 'Konnektor (MCP)',
  'Paste this into Claude': 'Das hier in Claude einfügen',
  'And when you are done, from the terminal': 'Und wenn Sie fertig sind, im Terminal',
  'Comments are deliberately left out: they may name colleagues.': 'Kommentare bleiben bewusst draußen: Sie können Namen von Kolleginnen und Kollegen enthalten.',
  'With the connector installed, Claude Desktop reads your tasks and writes back the result. It acts with your own permissions: it cannot do anything you could not do here.': 'Mit installiertem Konnektor liest Claude Desktop Ihre Aufgaben und schreibt das Ergebnis zurück. Er handelt mit Ihren Rechten: Er kann nichts tun, was Sie hier nicht auch könnten.',
  'Install once, from the repository': 'Einmalig installieren, aus dem Repository',
  'Then just ask Claude': 'Dann fragen Sie Claude einfach',
  'Copy': 'Kopieren',
  'Copied': 'Kopiert',
  'Could not copy. Select the text and copy it manually.': 'Kopieren hat nicht geklappt. Markieren Sie den Text und kopieren Sie ihn von Hand.',
};

                ...
                <div key={dept.department}>
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <span className="text-sm text-muted-foreground">
                      {t('Tasks: {done}/{total}', { done: dept.completed, total: dept.total })}
                    </span>
                  </div>
                  ...
                  {dept.overdue > 0 && (
                    <div className="mt-1 text-xs text-destructive flex items-center gap-1">
                      ...
                      {t('{count} overdue', { count: dept.overdue })}
                    </div>
                  )}
                </div>
              ))}
                ...
                <div key={item.employee?.id} className="flex items-center gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="text-xs text-muted-foreground">
                      {t('Completed: {done} • Rate: {rate}%', { done: item.completed, rate: item.completionRate })}
                    </div>
                  </div>
